...
export default function Booking5() {
  ...
  function submitBooking() {
    Axios.post("http://localhost:3001/api/insert5", {
      Name: Name,
      Email: Email,
  ...
  useEffect(() => {
    Axios.get("http://localhost:3001/api/getFood5").then((response) => {
      ...
      <div id="tab_one">
        <div className="register-photo">
          <div className="form-container">
            <div className="image-holder-5"></div>
            <form>
        ...
        <center>
          ...
          <table class="table table-primary col-xs-2 col-md-4 w-auto">
            ...
            <button
              ...
              onClick={() => {
                submitBooking();
                window.location.href='http://localhost:3000/booking-restaurant-5';
              }}
            >
              Fork-It
            </button>
