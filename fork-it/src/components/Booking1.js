...
export default function Booking1() {
  ...
  function submitBooking() {
    Axios.post("http://localhost:3001/api/insert1", {
      Name: Name,
      Email: Email,
  ...
  useEffect(() => {
    Axios.get("http://localhost:3001/api/getFood1").then((response) => {
      ...
      <div id="tab_one">
        <div className="register-photo">
          <div className="form-container">
            <div className="image-holder-1"></div>
            <form>
        ...
        <center>
          ...
          <table class="table table-primary col-xs-2 col-md-4 w-auto">
            ...
            <button
              ...
              onClick={() => {
                submitBooking();
                window.location.href='http://localhost:3000/booking-restaurant-1';
              }}
            >
              Fork-It
            </button>
